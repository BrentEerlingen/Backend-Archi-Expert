...
declare const BackendArchiExpertApplication_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
    bootOptions?: {
        [prop: string]: any;
...
export declare class BackendArchiExpertApplication extends BackendArchiExpertApplication_base {
